...
i = 0
x = 1; y = 1; xo = 0; yo = 0; ho = 0; wo = 0; xv = 0; yv = 0; ao = 0
...
while True:
	...
	for c in cnts:
		...
		if  x < 500: #Filtering
			...
			cv2.circle(frame, (int(x+w/2), int(y+h/2)), radius=int(80*(w/h)), color=(0, 0, 255), thickness=1)
			...
			im = cv2.circle(im, (x, y), radius=4, color=(0, 0, 255), thickness=-1)
			#print(x, xo)
			ao = a
